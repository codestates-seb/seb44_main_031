...
public class AuthService {
    ...
    public void reissue(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(request.getHeader("Refresh")==null) {
            throw new BusinessLogicException(ExceptionCode.REFRESH_TOKEN_NULL);
        }
        ...
        if(refreshToken.equals(refreshTokenInDb)) {
            ...
            throw new BusinessLogicException(ExceptionCode.REFRESH_TOKEN_TAMPERED);
        }
    }
    ...
    public void checkDuplicateEmailAndSendVerificationEmail(final String email) {
        if (!checkDuplicatedEmail(email)) throw new BusinessLogicException(ExceptionCode.INVALID_INPUT_VALUE);
        sendEmail(email);
    }
