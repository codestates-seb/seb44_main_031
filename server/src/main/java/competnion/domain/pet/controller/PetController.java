...
public class PetController {
    ...
    public Response<PetResponse> postPet(
    ...
    public Response<Void> deletePet(@AuthenticatedUser final User user, @Positive @PathVariable("pet-id") final Long petId) {
